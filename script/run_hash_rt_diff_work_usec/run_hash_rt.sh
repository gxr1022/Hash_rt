...
for num_of_ops in ${num_of_ops_set[*]};do
    ops_log_path=${LOG_PATH}/work_usec_${work}
...
${RUN_PATH}/script/run_hash_rt_diff_work_usec/extract_partitioned_time.sh ${current}
python ${RUN_PATH}/script/run_hash_rt_diff_work_usec/plot_combined_bar_diff_cores.py ${current}
...
${RUN_PATH}/script/run_hash_rt_diff_ops/extract_partitioned_time.sh ${current}
python ${RUN_PATH}/script/run_hash_rt_diff_ops/plot_combined_bar_diff_cores.py ${current}
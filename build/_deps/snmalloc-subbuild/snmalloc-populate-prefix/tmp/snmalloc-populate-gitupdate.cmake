...
execute_process(
  COMMAND "/usr/bin/git" show-ref "d8f174c717500a834229da5f1f6bfe888442e81a"
  WORKING_DIRECTORY "/mnt/nvme0/home/gxr/Myhash_boc/Hash_rt/build/_deps/snmalloc-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/nvme0/home/gxr/Myhash_boc/Hash_rt/build/_deps/snmalloc-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/nvme0/home/gxr/Myhash_boc/Hash_rt/build/_deps/snmalloc-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
